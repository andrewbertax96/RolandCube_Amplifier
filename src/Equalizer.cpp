...
void Equalizer::process (const float* inData, float* outData,
...
void Equalizer::setParameters(float bass_slider, float mid_slider, float treble_slider, float presence_slider)
{
...
void Equalizer::resetSampleRate()
{
    xHI = exp(-2.0 * pi * treble_frequency / srate);
    a0HI = 1.0 - xHI;
    b1HI = -xHI;
